...
## How to use
- Side A: enter one code, or press `+` to add more code boxes and download several codes in one run.
...
- You can paste several codes into Side A; the app will make extra code boxes for them when possible.
